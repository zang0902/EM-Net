...
class PatchExpand_Up(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(x.shape, 'xxxxxxxxxxxxxxxxxxxx',self.input_resolution)
...
class VTUNet(SegmentationNetwork):
    ...
    def __init__(self, in_channel=1, out_channel=9,
                 pretrain_ckpt="./pretrained_ckpt/swin_tiny_patch4_window7_224_22k.pth", 
        ...
        self.swin_unet = SwinTransformerSys3D(img_size=self.input_size,
